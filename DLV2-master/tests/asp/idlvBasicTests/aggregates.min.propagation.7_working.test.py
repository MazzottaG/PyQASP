...
mcDepot(H,K) | mcDepotNot(H,K) :- mcBurger(H,K). 
...
"""
output = """
{dist(1,12,12,0), dist(1,12,21,9), dist(1,21,12,9), dist(1,21,21,0), dist(1,4,12,8), dist(1,4,21,17), highway(1), km(1,25), loc_dist(1,12,0), loc_dist(1,21,0), loc_dist(1,4,8), mcBurger(1,12), mcBurger(1,21), mcBurger(1,4), mcDepot(1,12), mcDepot(1,21), mcDepotNot(1,4), nDepots(1,2)}
{dist(1,12,12,0), dist(1,12,4,8), dist(1,21,12,9), dist(1,21,4,17), dist(1,4,12,8), dist(1,4,4,0), highway(1), km(1,25), loc_dist(1,12,0), loc_dist(1,21,9), loc_dist(1,4,0), mcBurger(1,12), mcBurger(1,21), mcBurger(1,4), mcDepot(1,12), mcDepot(1,4), mcDepotNot(1,21), nDepots(1,2)}
"""
