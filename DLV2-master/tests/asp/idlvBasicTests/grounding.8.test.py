...
att_val(m12,title,"ArsenicandOldLace").
...
"""
output = """
{acted(perGrant,m12), att_val(m12,releaseDate,1944), att_val(m12,title,"ArsenicandOldLace"), att_val(nameCG,firstName,"Cary"), att_val(nameCG,lastName,"Grant"), att_val(nameGrant,firstName,"Alec"), att_val(nameGrant,firstName,"Archibald"), att_val(nameGrant,lastName,"Leach"), att_val(perGrant,birthDate,1904), att_val(perGrant,dateOfDeath,1986), att_val(perGrant,name,nameCG), att_val(perGrant,name,nameGrant), inferred_topic(q1,"Grant"), inferred_topic(q1,"Leach"), instance(m12,s_Movie), instance(nameCG,name), instance(nameGrant,name), instance(perGrant,s_Actor), involved(perGrant,m12), matchingMovie(q1,m12)}
"""
