...
Variables::Variables() : assignedVariablesSize(0), nextVariableToPropagate(0), noUndefinedBefore(1), numOfVariables(1) {
...
Variables::~Variables()
{
    for(unsigned int i = 1; i < numOfVariables; i++) {
        if(hasBeenEliminated(i)) delete variablesData[ i ].implicant;
